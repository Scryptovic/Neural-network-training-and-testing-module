...
Original file is located at
    https://colab.research.google.com/drive/1ReNDgEV6JlFKFF6h6NTWilmX-zy1SmkD
...
matrix_np = np.genfromtxt('/content/agent_connections_matrix2.csv', delimiter=';', dtype=str)
...
with open('modified_matrix4.csv', 'w', newline='') as csvfile:
...
matrix = pd.read_csv('/content/modified_matrix4.csv', sep = ';', header=None)
